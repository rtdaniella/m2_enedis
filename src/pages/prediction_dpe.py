...
cat_features =['classe_altitude', 'code_postal_ban', 'logement', 'n_etage_appartement',
       'passoire_energetique', 'periode_construction',
       'qualite_isolation_enveloppe', 'qualite_isolation_menuiseries',
       'qualite_isolation_murs', 'qualite_isolation_plancher_bas',
       'type_batiment', 'type_energie_n_1', 'type_installation_chauffage',
       'zone_climatique'] 
num_features = ['conso_5_usages_e_finale', 'cout_total_5_usages',
...
form_inputs = generate_form_fields(df, form_fields, cat_features, num_features)
