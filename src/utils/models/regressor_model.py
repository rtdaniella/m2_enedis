...
def train_regressor(X_train, y_train, X_test, y_test):
    ...
    X_train, X_test, y_train, y_test,num_features,cat_features =  preprocess_splitted_data(df,'conso_5_usages_e_finale')
...
# Meilleurs paramètres
    ...
    joblib.dump(best_model, 'models/regressor_model.joblib')

def load_regressor():
    # Charger le modèle
    return joblib.load('models/regressor_model.joblib')